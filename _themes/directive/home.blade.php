...
@section('content')
	...
	<div class="box alt container">
		<section class="feature left">
			<a href="#" class="image icon fa-code"><img src="_themes/directive/images/pic01.jpg" alt="" /></a>
			<div class="content">
		...
		<section class="feature right">
			<a href="#" class="image icon fa-pencil"><img src="_themes/directive/images/pic02.jpg" alt="" /></a>
			<div class="content">
		...
		<section class="feature left">
			<a href="#" class="image icon fa-file-code-o"><img src="_themes/directive/images/pic03.jpg" alt="" /></a>
			<div class="content">
